...
function createList(){
    apiAdminGetRecord('configModel', 0, 100, {}, function (data) {
        let shopItems = [];
...
function deleteItem(data){
    ...
    apiAdminUpdateRecord('configModel', {key: 'shopItems'}, {value: JSON.stringify(rows)}, function () {
        createList();
        alert("删除成功");
    });
}
...
function addItem(data){
    ...
    apiAdminGetRecord('publicParameterModel', 0, 100, {}, function (data) {
        ...
        if (isExist){
            ...
            apiAdminAddRecord('configModel', {key: 'shopItems', value: JSON.stringify(rows)}, function () {
                createList();
                alert("添加成功");
            })
        }
